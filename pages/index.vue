          ...
          <div class="flex items-center px-4">
            <div class="flex-shrink-0">
              <img
                ...
                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=9oOgsmAJHk&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                alt=""
              />
            </div>
            <div class="ml-3">
    ...
    <div class="py-10">
      ...
      <main class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <lexicon-term v-for="term in terms" :key="term.slug" :term="term" />
        </div>
      </main>
    </div>
  </div>
